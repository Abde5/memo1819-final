...
then $G$ is a unit interval graph (UIG). UIG is equivalent to the proper interval graphs class, where no interval can be properly included in another one \todo{put reference}.
...
We will present each family of subgraphs and analyze whether they are included in other relevant classes of graphs (e.g. unit disk graphs). Only properties that will be used in next chapters will be presented,
