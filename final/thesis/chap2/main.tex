...
\begin{itemize}
  ...
  \end{itemize}
\end{itemize}
That is, because we cannot find an odd cycle with a triangular chord, the $\mathcal{R}^C$ is a family of comparability graphs, so $\mathcal{R}$ is a family of co-comparability graphs. \qed}
