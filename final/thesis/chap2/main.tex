...
\begin{theorem}[Gilmore and Hoffman \cite{gilmoreCharacterizationComparabilityGraphs1964}]
  ...
  $G$ is an interval graph if and only if $G$ does not contain $C_4$ as an induced subgraph and $\overline{G}$ has a transitive orientation (it is a co-comparability graph).
\end{theorem}
