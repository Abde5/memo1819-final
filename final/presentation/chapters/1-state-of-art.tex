...
\begin{frame}{Mixed unit interval graphs}

  A \emph{mixed unit interval graph} is an intersection graph of unita intervals in the real line. The interval of mixed unit interval graphs can be open, closed, open-closed or closed-open.
  \vfill
  \pause
...
\begin{frame}{Mixed unit interval graphs}
Joos characterizes mixed unit interval graphs with an exhaustive list of families of minimal forbidden subgraphs.
\vfill
...
\begin{frame}{Unfettered unit interval graphs}
  An \emph{unfettered unit interval graph} is an intersection graph of unit intervals in the real line. However, if two intervals \emph{kiss}, we can choose whether they are adjacent or not.
  \vfill
  \pause
  \begin{columns}
...
\begin{frame}{Thin strip graphs}
  \begin{definition}
      The class of \emph{thin strip graphs} is defined as $\text{TSG} = \cap_{c>0} \text{SG}(c)$.
  \end{definition}
  \vfill
  \begin{figure}
  \centering
