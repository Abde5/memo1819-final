...
\begin{frame}{Mixed unit interval graphs}
  ...
  A \emph{mixed unit interval graph} is an intersection graph of unit intervals in the real line. Each interval in the representation can be can be open, closed, open-closed or closed-open.
  \vfill
  \pause
...
\begin{frame}{Unfettered unit interval graphs}
  ...
  \begin{theorem}[Hayashi \textit{et al.}, 2017]
