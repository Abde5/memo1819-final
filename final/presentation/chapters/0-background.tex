...
\begin{frame}{Context}
The class of thin strip graphs lies between interval graphs and unit disk graphs in the inclusion order.
...
\begin{frame}{Context}
  The research in this thesis is based on three papers.
